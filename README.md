...
- **機能: 自動位置測位 / 自動ピン配置 / 自動 Guess 送信 / クイズ自動回答（国・選択問題） / 位置情報ポップアップ表示**<br>
...
| **クイズ自動回答** | ライブチャレンジのクイズ問題で、国選択・単一選択・選択座標問題を自動送信。 |
...
| **Auto Quiz** | クイズ問題（国選択・単一選択・選択座標）を自動送信 | ON |
